      ...
      <div className="p-7 py-9 h-screen md:flex md:h-[83vh] relative">
        <div className="flex flex-col gap-7 md:max-w-md lg:max-w-none lg:justify-center">
          ...
          <div className="flex flex-col sm:flex-row md:flex-col lg:flex-row md:items-start sm:items-center gap-6">
            <button className="bg-white w-64 font-medium flex items-center justify-center rounded-full p-4 text-md hover:shadow-2xl hover:text-discord_blurple focus:outline-none transition duration-200 ease-in-out">
              <DownloadIcon className="w-6 mr-2" />
              Download for Windows
            </button>
            <button className="bg-gray-900 text-white w-64 font-medium flex items-center justify-center rounded-full p-4 text-md hover:shadow-2xl hover:bg-gray-800 focus:outline-none transition duration-200 ease-in-out">
        ...
        <div className="flex-grow flex">
          ...
          <img
            src={Hero2}
            alt=""
            className="hidden md:inline absolute lg:self-center"
          />
        </div>
      </div>
    </div>
